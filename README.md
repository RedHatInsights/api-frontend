...
- CI is handled by [Konflux](https://konflux-ci.dev/) pipelines defined in `.tekton/`
  - Pull requests and pushes to `master` trigger automated builds, linting, and tests
...
When you want to test your code with unit tests please use `jest`, which is preconfigured in a way to collect code coverage as well.
